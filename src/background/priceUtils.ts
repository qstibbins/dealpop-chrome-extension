export async function extractPriceFromStructuredData(url: string): Promise<number | null> {
    ...
    chrome.scripting.executeScript(
      {
        ...
        func: () => {
          ...
          function extractPriceFromStructuredDataInner(): number | null {
...
export async function extractPriceFromDOM(url: string, selector: string): Promise<number> {
  const tab = await chrome.tabs.create({ url, active: false });
  return new Promise((resolve, reject) => {
    chrome.scripting.executeScript(
      {
...
export async function extractPrice(url: string, selector?: string): Promise<number> {
